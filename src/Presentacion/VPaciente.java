...
public class VPaciente extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        LblPApellido.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        LblPApellido.setText("Primer Apellido:");

        LblSApellido.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VPaciente dialog = new VPaciente(new javax.swing.JFrame(), true, 14);
